...
Business Problem-
Spotify wants to understand user listening behavior and engagement in order to improve user experience, increase listening time and reduce song skips

Goal of the dashboard-
To analyze listening behavior and understand how, when, and what users listen to on Spotify, so that we can identify listening patterns, favorite artists/tracks, engagement levels, and skip behavior
...
Charts-
1) What time period should the analysis focus on?
Should we analyze the entire history or compare different years/months?

2) Which artists and tracks are most important to the user?
Can we identify the top artists, albums, and songs based on actual listening time rather than simply play count?

3) Which platforms are being used most?
Does behavior differ between mobile, desktop, web, or other platforms?

4) Why are users skipping tracks?
Can we identify patterns between skipped, ms_played, artist, track, time of day, or listening platform?

5) Does shuffle mode affect listening behavior?
...
“The dashboard shows a highly engaged Spotify user with over 5,300 hours of listening across 4,100+ artists. Listening activity peaked during 2020–2021, with Android and shuffle mode dominating usage. The low overall skip rate indicates strong engagement, while the recent decline in listening time and increase in skips suggest changing listening behavior in the later years.”
